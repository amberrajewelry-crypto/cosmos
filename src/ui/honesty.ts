...
export function openHonesty(overlay: HTMLElement): void {
  ...
  overlay.innerHTML = `
    <div class="honesty-box">
      ...
      <p class="honesty-p"><b>Контент-база (77 параметров по уровням масштаба):</b> у каждого указан источник и тег, 10 из них сверены с JPL Horizons, BGS и Planck (пометка «сверено A4»), остальные помечены «не сверено», а тег [ТОЧНО] им структурно не выдаётся — максимум [ОЦЕНКА]. Сверка идёт порциями; расхождения будут здесь.</p>
