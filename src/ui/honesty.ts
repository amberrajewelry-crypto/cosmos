...
export function openHonesty(overlay: HTMLElement): void {
  ...
  overlay.innerHTML = `
    <div class="honesty-box">
      ...
      <p class="honesty-p"><b>Контент-база (77 параметров по уровням масштаба):</b> у каждого указан источник и тег, 43 из них сверены (проходы A4 от 14–16.09: JPL Horizons, BGS, Planck 2018, HPS, LLR, первоисточники по клеткам и Галактике), остальные помечены «не сверено», а тег [ТОЧНО] им структурно не выдаётся — максимум [ОЦЕНКА]. Найденные расхождения исправлены и записаны: наклон магнитного диполя был 11° (учебное значение 1980-х) — теперь 9.3° по IGRF.</p>
