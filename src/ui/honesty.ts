...
export function openHonesty(overlay: HTMLElement): void {
  ...
  overlay.innerHTML = `
    <div class="honesty-box">
      ...
      <p class="honesty-p"><b>Контент-база (77 параметров по уровням масштаба):</b> у каждого указан источник и тег, но внешняя сверка A4 по ним ещё не проведена — в карточках они помечены «не сверено», а тег [ТОЧНО] им структурно не выдаётся — максимум [ОЦЕНКА]. Сверка идёт порциями; расхождения будут здесь.</p>
